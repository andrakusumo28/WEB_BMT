...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>SISFOPBMT</title>
        
        <link href="css/HeaderFooter.css" rel="stylesheet">
        <link href="css/InfoTagihan.css" rel="stylesheet">
        <link href="css/MenuUtama.css" rel="stylesheet">
        <!-- Insert Google Analytics code here -->
    </head>
    <body>
        <div id="FooterLayer" style="position:absolute;text-align:center;left:0px;bottom:0px;width:100%;height:50px;z-index:2;" title="Footer">
            <div id="FooterLayer_Container" style="width:1366px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
            </div>
        </div>
        <div id="HeaderLayer" style="position:absolute;text-align:left;left:0px;top:0px;width:100%;height:123px;z-index:3;" title="Header">
        ...
        <div id="container">
            <div id="wb_Image1" style="position:absolute;left:0px;top:125px;width:1366px;height:476px;z-index:4;">
                <img src="images/pbmt04.jpg" id="Image1" alt=""></div>
            <div id="wb_Form1" style="position:absolute;left:227px;top:164px;width:929px;height:386px;z-index:5;">
                <form name="Form1" method="post" action="" enctype="text/plain" id="Form1">
                    <input type="submit" id="Button1" name="NAMA BMT" value="NAMA BMT" style="position:absolute;left:340px;top:44px;width:248px;height:39px;z-index:1;">
                </form>
            </div>
            <label for="" id="Label2" style="position:absolute;left:204px;top:179px;width:983px;height:26px;line-height:26px;z-index:6;">INFO TAGIHAN</label>
            <div id="wb_CssMenu1" style="position:absolute;left:0px;top:83px;width:1366px;height:41px;text-align:center;z-index:7;">
                <ul>
